package br.com.ecommerce.logistica.subscriber;

import br.com.ecommerce.logistica.publisher.EnvioPedidoPublisher;
import br.com.ecommerce.logistica.service.EnvioPedidoService;
import br.com.ecommerce.logistica.subscriber.representation.AtualizacaoFaturamentoRepresentation;
...
public class FaturamentoSubscriber {
    ...
    @KafkaListener(groupId = "${spring.kafka.consumer.group-id}", topics = "${ecommerce.config.kafka.topics.pedidos-faturados}")
    public void listen(String json) {
        ...
        try {
            ...
            log.error("Erro ao preparar pedido para enviar");
        }
    }
}
